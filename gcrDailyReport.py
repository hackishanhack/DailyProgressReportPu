...
#Variable Names
date = "02-06" # SET Date as Name - "DD-MM" to the CSV file
...
#Milestone Leaderboard Page
    ...
    with(header):
        st.image('images/banner.png', use_column_width=True)
        st.markdown("<h1><b>Milestone Leaderboard 🏃‍♂️ Poornima University</b></h1>", unsafe_allow_html=True)
        st.write("Last Updated On: " + date + "-2022")
        st.write("#####")
    ...
    if(textInput != "" and status):
        ...
        st.error("Sorry, we won't be able to show you the Milestone Achievers unless and untill you are a Participant under GCRF Program Poornima University")
